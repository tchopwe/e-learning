                               ...
                               <div class="col-lg-6">
								<form method="post" action="views/Semestre/UpdateSemestre.php" enctype="multipart/form-data" class="ajax-form">
									...
									<div><!-- Je Dois Mettre Le Nom de La Colonne Sur For, Id, Name Et Aussi dans $LaListe -->
										...
										<input type="text" name="id_semestre" class="form-control"  size="50" id="id_semestre" value="<?php echo $LaListe['id_semestre']; ?>"/>
									</div>
									...
									<a href="views/Semestre/ListeSemestre.php" class="ajax-link"> <button class="btn btn-danger"> Annuler</button></a>
