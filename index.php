<?php require_once("action/connexion.php") ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>E-Learning MINESUP</title>
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image"><br><br><br><br><br>
                                <center><img src="img/logo_minesup.jpg" alt=""></center>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="action/usersConnexion.php" method="POST" class="user">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                name="email"
                                                placeholder="Entrez votre addresse mail svp...">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                             name="Mot_de_Passe" placeholder="Entrez votre mot de passe svp...">
                                        </div>
                                        <div class="form-group">
