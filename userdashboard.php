<?php
	...
	$ListedesTable = $dam->query("SELECT * FROM fichier"); // Je Mets Le Nom de Ma Table à Manipuler

    $nombrefichier= $ListedesTable->rowCount();
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-4">
                                                <h5><b>Total fichier</b></h5></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><h5><b><?= $nombrefichier ?></b></h5></div>
                                        </div>
                                        <div class="col-auto">
